...
<html>
	...
	<body onload="startTime()">
		...
		<div class="center">
			<img src="Images/F1Title.jpg" style="width:100px; height:40px; margin-left:5px; margin-top:5px;">
			<h2 style="display: inline; margin-left:-2px; vertical-align:text-bottom;">
				Seberapa Tahankah Anda pada Kecepatan Tinggi?
			</h2><br><br>
			<p>
				<?php
					include "db.inc.php";
					...
					$offset=($halaman-1)*8;
					$sqlstr = "SELECT * from articles WHERE id_topik='2' order by id DESC limit $offset,8";
					...
					//paginasi halaman
					$sqlstr = "SELECT * from articles WHERE id_topik='2'";
					...
					{
						$awal = (($j-1)*4+$j)-1;
						echo "[<a href='f1.php?awal=$awal&page=$j'>$j</a>]";
					}
				?>
			</p>
		</div>
