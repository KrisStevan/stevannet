...
<html>
	...
	<body onload="startTime()">
		...
		<div class="center">
			<img src="Images/collectTitle.jpg" style="width:100px; height:40px; margin-left:5px; margin-top:5px;">
			<h2 style="display: inline; margin-left:-2px; vertical-align:text-bottom;">
				Ini Koleksiku, Ada yang Kalian Suka?
			</h2><br><br>
			<p>
				<?php
					include "db.inc.php";
					...
					$offset=($halaman-1)*8;
					$sqlstr = "SELECT * from articles WHERE id_topik='10' order by id DESC limit $offset,8";
					...
					//paginasi halaman
					$sqlstr = "SELECT * from articles WHERE id_topik='10'";
					...
					{
						$awal = (($j-1)*4+$j)-1;
						echo "[<a href='mycollections.php?awal=$awal&page=$j'>$j</a>]";
					}
				?>
			</p>
		</div>
