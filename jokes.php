...
function renderCenter() {
	...
	$offset=($halaman-1)*8;
	$sqlstr = "SELECT * from articles WHERE id_jenis='3' order by id DESC limit $offset,8";
	...
	//paginasi halaman
	$sqlstr = "SELECT * from articles WHERE id_jenis='3'";
	...
	{
		$awal = (($j-1)*4+$j)-1;
		echo "[<a href='jokes.php?awal=$awal&page=$j'>$j</a>]";
	}
}
