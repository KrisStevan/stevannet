...
<html>
	...
	<body onload="startTime()">
		...
		<div class="center">
			<img src="Images/historyTitle.jpg" style="width:120px; height:40px; margin-left:5px; margin-top:5px;">
			<h2 style="display: inline; margin-left:-1px; vertical-align:text-bottom;">
			...
			<p>
				<?php
					...
					$offset=($halaman-1)*8;
					$sqlstr = "SELECT * from articles WHERE id_topik='11' order by id DESC limit $offset,8";
					...
					//paginasi halaman
					$sqlstr = "SELECT * from articles WHERE id_topik='11'";
					...
					{
						$awal = (($j-1)*4+$j)-1;
						echo "[<a href='sejarahterbaik.php?awal=$awal&page=$j'>$j</a>]";
					}
				?>
			</p>
		</div>
