...
<html>
	...
	<body onload="startTime()">
		...
		<div class="center">
			<img src="Images/foreignTitle.jpg" style="width:80px; height:40px; margin-left:5px; margin-top:5px;">
			<h2 style="display: inline; margin-left:-2px; vertical-align:text-bottom;">
				Mari Terjemahkan Maksud Sebuah Lagu dalam Bahasa Lain
			</h2><br>
			<p>
				<?php
					include "db.inc.php";
					...
					$offset=($halaman-1)*5;
					$sqlstr = "SELECT * from articles WHERE id_topik='6' order by id DESC limit 5";
					...
					do{
						...
						echo "<a href='cover_detail.php?id=$id'>$tanggal_muat<br>$judul</a><br>";
						$isian = substr($isi,0,150);
						echo "<br><br>";
					}while($row=mysqli_fetch_row($hasil_1));
					
					//paginasi halaman
					$sqlstr = "SELECT * from articles WHERE id_topik='6'";
					...
					{
						$awal = (($j-1)*4+$j)-1;
						echo "[<a href='coverasing.php?awal=$awal&page=$j'>$j</a>]";
					}
				?>
			</p>
		</div>
