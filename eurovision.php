...
<html>
	...
	<body onload="startTime()">
		...
		<div class="center">
			<img src="Images/EurovisionTitle.jpg" style="width:268px; height:40px; margin-left:5px; margin-top:5px;">
			<h2 style="display: inline; margin-left:-2px; margin-top:-10px;">Menyatukan Bangsa Lewat Festival</h2><br><br>
			<p>
				<?php
					include "db.inc.php";
					...
					$offset=($halaman-1)*8;
					$sqlstr = "SELECT * from articles WHERE id_topik='1' order by id DESC limit $offset,8";
					...
					//paginasi halaman
					$sqlstr = "SELECT * from articles WHERE id_topik='1'";
					...
					{
						$awal = (($j-1)*4+$j)-1;
						echo "[<a href='eurovision.php?awal=$awal&page=$j'>$j</a>]";
					}
				?>
			</p>
		</div>
