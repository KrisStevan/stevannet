...
<html>
	...
	<body onload="startTime()">
		...
		<div class="center">
			<img src="Images/olympicsTitle.jpg" style="width:100px; height:40px; margin-left:5px; margin-top:5px;">
			...
			<p>
				<?php
					...
					$offset=($halaman-1)*8;
					$sqlstr = "SELECT * from articles WHERE id_topik='3' order by id DESC limit $offset,8";
					...
					//paginasi halaman
					$sqlstr = "SELECT * from articles WHERE id_topik='3'";
					...
					{
						$awal = (($j-1)*4+$j)-1;
						echo "[<a href='eurogames.php?awal=$awal&page=$j'>$j</a>]";
					}
				?>
			</p>
		</div>
